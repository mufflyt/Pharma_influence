...
# SAVE MODEL RESULTS-----------------------------
saveRDS(result_anti_inf, "Z:\\Pharma_Influence\\Code\\AF\\prelim results\\anti_inf.5000.50000.10.poisson.rds")
saveRDS(result_antichol, "Z:\\Pharma_Influence\\Code\\AF\\prelim results\\antichol.5000.50000.10.poisson.rds")
saveRDS(result_antiviral, "Z:\\Pharma_Influence\\Code\\AF\\prelim results\\antiviral.5000.50000.10.poisson.rds")
saveRDS(result_bisp, "Z:\\Pharma_Influence\\Code\\AF\\prelim results\\bisp.5000.50000.10.poisson.rds")
saveRDS(result_hormone, "Z:\\Pharma_Influence\\Code\\AF\\prelim results\\hormone.5000.50000.10.poisson.rds")
saveRDS(result_oral, "Z:\\Pharma_Influence\\Code\\AF\\prelim results\\oral.5000.50000.10.poisson.rds")
saveRDS(result_transderm, "Z:\\Pharma_Influence\\Code\\AF\\prelim results\\transderm.5000.50000.10.poisson.rds")
saveRDS(result_vaginal, "Z:\\Pharma_Influence\\Code\\AF\\prelim results\\vaginal.5000.50000.10.poisson.rds")
...
# READ IN ---------------------------------------
result_anti_inf <- readRDS("Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\anti_inf.5000.50000.10.poisson.rds")
result_antichol <- readRDS("Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\antichol.5000.50000.10.poisson.rds")
result_antiviral<- readRDS("Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\antiviral.5000.50000.10.poisson.rds")
result_bisp     <- readRDS("Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\bisph.5000.50000.10.poisson.rds")
result_hormone  <- readRDS("Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\hormone.5000.50000.10.poisson.rds")
result_oral     <- readRDS("Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\oral.5000.50000.10.poisson.rds")
result_transderm<- readRDS("Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\transderm.5000.50000.10.poisson.rds")
result_vaginal  <- readRDS("Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\vaginal.5000.50000.10.poisson.rds")
...
write.csv(save_bisp, "Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\bisph_coeff.csv")

save_anti_inf <- data.frame(summary(result_anti_inf)$solutions)  #save coefficents
write.csv(save_anti_inf, "Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\anti_inf_coeff.csv")

save_antichol <- data.frame(summary(result_antichol)$solutions)  #save coefficents
write.csv(save_antichol, "Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\antichol_coeff.csv")

save_antiviral <- data.frame(summary(result_antiviral)$solutions)  #save coefficents
write.csv(save_antiviral, "Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\antiviral_coeff.csv")

save_hormone <- data.frame(summary(result_hormone)$solutions)  #save coefficents
write.csv(save_hormone, "Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\hormone_coeff.csv")

save_oral <- data.frame(summary(result_oral)$solutions)  #save coefficents
write.csv(save_oral, "Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\oral_coeff.csv")

save_transderm <- data.frame(summary(result_transderm)$solutions)  #save coefficents
write.csv(save_transderm, "Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\transderm_coeff.csv")

save_vaginal <- data.frame(summary(result_vaginal)$solutions)  #save coefficents
write.csv(save_vaginal, "Z:\\Pharma_Influence\\Results\\Model results 01.23.2020\\vaginal_coeff.csv")
